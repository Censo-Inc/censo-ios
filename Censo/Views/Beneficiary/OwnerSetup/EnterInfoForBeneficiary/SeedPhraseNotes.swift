...
extension EnterInfoForBeneficiary {
    struct SeedPhraseNotes: View {
        ...
        var body: some View {
            ...
            .navigationInlineTitle("Legacy - \(seedPhrase.label)")
        }
        ...
        struct NotesEditor: View {
            ...
            var saveButtonLabel: String = "Save information"
