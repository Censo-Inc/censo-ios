...
extension BIP39 {
    ...
    static func phraseToBinaryData(phrase: String, language: WordListLanguage = .english) throws -> Data {
        let normalizedPhrase = phrase.trimmingCharacters(in: .whitespacesAndNewlines).lowercased()
    ...
    static func binaryDataToWords(binaryData: Data, language: WordListLanguage? = nil) throws -> [String] {
        ...
        case .none:
            ...
            wordlist = wordlists[try WordListLanguage.fromId(id: languageId)]!
        case .some(let lang):
